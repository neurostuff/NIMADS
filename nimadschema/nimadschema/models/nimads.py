...
#   filename:  nimads.yml
#   timestamp: 2022-05-12T03:52:28+00:00
...
class NoteCollectionRelationships(BaseModel):
...
class StudyRelationships(BaseModel):
...
class AnalysisRelationships(BaseModel):
